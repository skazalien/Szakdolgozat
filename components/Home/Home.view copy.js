...
class Home extends Component {
  ...
  handleLogoutModal = answer => {
    ...
    if (answer) {
      const url = configjson.base_url + 'login_postman/logout.php';
  ...
  renderLeftMenu() {
    return (
      <Animated.View
        ...
        <View style={{width: 250, backgroundColor: 'black'}}>
          <TouchableWithoutFeedback
    ...
    return (
      <View
        ...
        <ScrollView
          ...
          {this.state.infos.length > 0 && !this.state.loading && (
            <View
              style={{
                width: '90%',
                marginLeft: 15,
              ...
              <TouchableOpacity
                ...
                onPress={() => Alert.alert('Message', 'yeet')}>
                <Text
                  style={{
                    paddingLeft: 10,
                    paddingTop: 5,
